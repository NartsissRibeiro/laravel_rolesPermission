...
id="deleteModalProduct{{ $product->id }}" tabindex="-1" aria-
labelledby="deleteModalLabel{{ $product->id }}" aria-hidden="true">
...
id="deleteModalLabel{{ $product->id }}">Confirmação de Exclusão</h5>
<button type="button"
...
@method('DELETE')
<button type="submit"
class="btn btn-danger btn-sm"><i class="bi bi-trash"></i> Deletar</button>
</form>
</div>
</div>
</div>
